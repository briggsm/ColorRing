...
// Clap
#define EEP_ENABLE_CLAP 0x10
#define EEP_CLAP_AMP_THRESHOLD 0x11
#define EEP_CLAP_MIN_DELAY_UNTIL_NEXT 0x12
#define EEP_CLAP_WINDOW_FOR_NEXT 0x13
#define EEP_CLAP_SHOW_TIME_NUM_SECONDS 0x14
