...
// Clap
#define EEP_ENABLE_CLAP_OUT 0x10
#define EEP_ENABLE_CLAP_IN 0x11
#define EEP_CLAP_AMP_THRESHOLD 0x12
#define EEP_CLAP_MIN_DELAY_UNTIL_NEXT 0x13
#define EEP_CLAP_WINDOW_FOR_NEXT 0x14
#define EEP_CLAP_SHOW_TIME_NUM_SECONDS 0x15
...
#define EEP_OUT_COLORED5S_ENABLE (EEP_OUT_START + 0x03)
#define EEP_OUT_COLORED5S_COLOR (EEP_OUT_START + 0x04)  // (3 bytes)

#define EEP_HOUR_HAND_OUT (EEP_OUT_START + 0x07)
#define EEP_MIN_HAND_OUT (EEP_OUT_START + 0x08)
#define EEP_SEC_HAND_OUT (EEP_OUT_START + 0x09)
...
#define EEP_IN_COLORED5S_ENABLE (EEP_IN_START + 0x03)
#define EEP_IN_COLORED5S_COLOR (EEP_IN_START + 0x04)  // (3 bytes)
#define EEP_HOUR_HAND_IN (EEP_IN_START + 0x07)
#define EEP_MIN_HAND_IN (EEP_IN_START + 0x08)
#define EEP_SEC_HAND_IN (EEP_IN_START + 0x09)

// Storage for Strip Cmds
#define EEP_STRIPCMDS_START (EEP_IN_START + EEP_IN_SIZE)
#define EEP_STRIPCMDS_SIZE 0x280  // 640 (320 for OUTSIDE, 320 for INSIDE)
...
#define WIFI_PACKET_SET_COLORED5S 0xBD
...
#define WIFI_PACKET_SET_ALL_STRIPCMDS_NONE 0xDC  //220
#define WIFI_PACKET_SET_STRIPCMD 0xDD  // 221
//#define WIFI_PACKET_SET_IN_STRIPCMD 0xDE
#define WIFI_PACKET_SET_CLAP_PARAMS 0xE0  // 224
...
#define OPMODE_AUDIOVISUALIZER 3
#define OPMODE_AUDIOLEVEL 4
